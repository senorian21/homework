...
describe("Videos API", () => {
  ...
  it("should create a video; POST /videos", async () => {
    ...
    expect(createdVideosResponse.body.availableResolutions).toEqual([Resolutions.P1440]);
  ...
  it("should update a video; PUT /videos/:id", async () => {
    ...
    const updateVideos1: UpdateVideoInputModel = {
      ...
      title: "update",
      author: "Valentin123",
      availableResolutions: [Resolutions.P2160, Resolutions.P480, Resolutions.P360],
